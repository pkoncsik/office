...
function _createTable() {
  _createTable = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        expensesTable = currentWorksheet.tables.add("A1:D1", true
                        /*hasHeaders*/
                        );
          ...
          case 5:
            ...
            if (_context4.t0 instanceof OfficeExtension.Error) {
              console.log("Debug info: " + JSON.stringify(_context4.t0.debugInfo));
            }
